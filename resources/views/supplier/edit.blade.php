    ...
    <form action="{{ route('supplier.update', $supplier->id) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nama_supllier" id="nama_supllier" 
                ...
                value="{{ old('nama_supllier', $supplier->nama_supllier) }}" required>
            @error('nama_supllier')
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nama_kontak" id="nama_kontak" 
                ...
                value="{{ old('nama_kontak', $supplier->nama_kontak) }}" required>
            @error('nama_kontak')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-4">
            <label for="no_telpon" class="block text-sm font-medium text-gray-700 mb-1">No HP</label>
            <input type="number" name="no_telpon" id="no_telpon" 
                ...
                value="{{ old('no_telpon', $supplier->no_telpon) }}" required>
            @error('no_telpon')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
